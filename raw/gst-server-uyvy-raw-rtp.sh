...
VELEM="filesrc location=$1 ! videoparse format=4 width=$WIDTH height=$HEIGHT framerate=$FRAMERATE ! queue"
VCAPS="video/x-raw-yuv, width=(int)$WIDTH, height=(int)$HEIGHT, format=(fourcc)UYVY"
